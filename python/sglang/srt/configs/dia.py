...
class DiaConfig(BaseModel, frozen=True):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """Load a Dia configuration from a pretrained model.

        Args:
            pretrained_model_name_or_path: The name or path of the pretrained model.
            revision: The specific model version to load (default is "main").
            **kwargs: Additional arguments for loading the configuration.

        Returns:
            A DiaConfig instance with the loaded configuration.
        """
        return
